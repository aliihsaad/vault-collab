...
export function getAgentOperatingGuide(options: AgentGuideOptions = {}): AgentOperatingGuide {
  return {
    ...
    safetyRules: [
      ...
      "Ping is a passive event unless the target agent checks attention or has watch-attention running.",
    ...
    toolMap: {
      ...
      watch: "CLI only: watch-attention polls vault_collab_get_session_attention and returns manual recommended actions.",
